...
if __name__ == "__main__":
    ...
    wb = xlrd.open_workbook('C:\\Users\\Ethan\\Borderlands2Project\\CSVs\\Master Relic List.xlsx')
    ...
    for i in range(sheet.nrows):
        ...
        # split[9] = rarity, sheet.cell_value(i,9)
            ...
            query = "insert into relic(manu_id, location_id, item_type, relic_name,relic_perk,manufacturer,location_name,damage_type, dropped_by, minimum_task, rarity, " \
